...
alert(
  `Welcome to our Switch Italian cuisine. Ready to order? - Click 'OK' to begin.`,
);
...
switch (typeChoice) {
  ...
  case "3":
    ...
    break;
  default:
    alert(`This was an invalid choice`);
}
...
if (foodType === "pizza") {
  ...
  switch (pizzaChoice) {
    case "1":
      finalDish = "Feta Cheese Pizza";
      break;
    case "2":
      finalDish = "Calzone";
      break;
    case "3":
      finalDish = "Bot-Spetzial Pizza";
      break;
    default:
      alert(`This was an invalid choice`);
  }
  ...
  switch (saladChoice) {
    case "1":
      finalDish = "Ceasar salad";
      break;
    case "2":
      finalDish = "Goat Cheese salad";
      break;
    case "3":
      finalDish = "Bot-Spetzial Salad";
      break;
    default:
      alert(`This is no salad`);
  }
}
